...
/*
 * 10/10 test cases
 * fixed long casting issues
 */
public class CityHorizon2 {
	static long sum = 0;
	public static void main(String args[]) throws IOException {
		...
		PriorityQueue<Integer> curHeights = new PriorityQueue<Integer>(1, Collections.reverseOrder()); // heights valid at that location
		...
		while(iterator.hasNext()) { // iterate through all the locations
			...
			if (curHeights.size() > 0) {
				sum += (long)(curHeights.peek()) * (long)(curPos - prevPos);
