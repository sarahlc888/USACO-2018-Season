...
public class KrushkalAdjList {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < E; i++) {
			...
			// add edge to graph, undirected so add it in both directions (optional step)
			adj.get(a).add(new Point(b, weight));
			adj.get(b).add(new Point(a, weight));
