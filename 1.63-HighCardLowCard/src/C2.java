/*
 * Find the maximum wins that Bessie has while knowing Elsie's hand.
 * does the same thing as silver but splits into the high and low segments
 * dec 2015 gold version
 * 
 * old version, pulled from onedrive
 */
...
public class C2 {
	...
	public static void main(String[] args) throws IOException {
		// read input
		Scanner input = new Scanner(new File("cardgame.in"));
		// n cards, n is even
		int n = input.nextInt();
		...
		System.out.println(Arrays.toString(eLo2));
		System.out.println(Arrays.toString(eHi));
		System.out.println(Arrays.toString(bLo2));
		System.out.println(Arrays.toString(bHi));
