...
public class HeatWave {
	...
	public static void main(String[] args) throws IOException {
		...
		int Ts = Integer.parseInt(st.nextToken()) - 1; // source node, fix indexing
		int Te = Integer.parseInt(st.nextToken()) - 1; // end node, fix indexing
		...
		if (dist[Te] == Integer.MAX_VALUE) dist[Te] = -1;
